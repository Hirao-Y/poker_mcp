# 🚀 NPX を使用したPoker MCPサーバーの起動 (v1.6.0)
...
> **⚠️ 版数の固定を推奨**
> `poker-mcp@latest` ではなく `poker-mcp@1.6.0` のように固定してください。
...
**Poker MCP Server v1.6.0** | 作者: Yoshihiro Hirao | ライセンス: ISC
