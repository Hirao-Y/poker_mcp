...
const physicsDatabase = {
    ...
    materials: {
        ...
        'heavy-concrete': {
            name: '重量コンクリート',
            density: 3.5, // g/cm³
            muMass: 0.0620, // cm²/g (Co-60)
            color: 0x776666,
            cost: 150, // 相対コスト/m³
            description: 'バライト・磁鉄鉱骨材、実用性重視'
        },
        'iron-shot': {
            name: '鉄ショット',
            density: 4.8, // g/cm³
            muMass: 0.0650, // cm²/g (Co-60)
            color: 0x664444,
            cost: 300, // 相対コスト/m³
            description: '金属骨材コンクリート、高密度'
        },
        'baryte': {
            name: 'バライト骨材',
            density: 4.2, // g/cm³
            muMass: 0.0610, // cm²/g (Co-60)
            color: 0x998877,
            cost: 200, // 相対コスト/m³
            description: '重晶石骨材、医療施設で使用'
        }
    }
};
